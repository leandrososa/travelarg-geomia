<template>
  <header>
    <v-container>
      <router-link
        v-if="$route.path != '/chatgeoguru' && $route.path != '/'"
        class="geomia"
        to="/"
      >
      ...
      <div
        v-if="!this.$session.exists('isLogged')"
        class="side-button unlogged-button"
      >
        <Button elevation="6" large paddingSm @click.native.stop="login = true"
          ><span class="ticon-login"></span> Ingresar</Button
        >
      </div>
      <div
        v-else-if="$route.path === '/perfilgeoguru'"
        class="side-button contract-geoguru"
      >
        <Button elevation="6" large paddingSm color="info"
          ><span class="ticon-chat"></span> Chatear con Estela</Button
        >
      </div>
      <div
        v-else-if="
          $route.path === '/nuevaresena' ||
            $route.path === '/componerresena' ||
            $route.path === '/resenacompleta' ||
            $route.path === '/chatgeoguru' ||
            $route.path === '/contratargeoguru'
        "
        class="side-button"
      ></div>
      <div
        v-else-if="this.$session.exists('isLogged')"
        class="side-button logged-button"
      >
        <Button to="/nuevaresena" elevation="6" large paddingSm color="success"
          ><span class="ticon-pencil"></span> Escribir reseña</Button
        >
      </div>
      <!-- LoginModal -->
          ...
          <v-row>
            <v-col cols="6">
              ...
              <div class="information">
                ...
                <p>
                  Al “Registrar” aceptas los <u>Terminos de uso</u> y
                  <u>Politicas de privacidad</u> de Geomia y TravelArg.
                </p>
              </div>
              <Button
                large
            ...
            <v-col cols="6">
              <div class="guru-register-box">
                ...
                <p class="guru-description">
                  Convierte tu tiempo libre en ganancias, compartiendo tus
                  experiencias a otros. ¡Es gratis!
                </p>

                <div class="information">
                  <span class="ticon-info"></span>
                  <p>
                    Vamos a pedirte información de contacto adicional una vez
                    confirmada la cuenta.
                  </p>
                </div>
                ...
                <Button
                  ...
                  @click.native.stop="
                    ...
                    guruRegister = true;
                  "
                  >Registrarse como Geogur&uacute;</Button
                >
              </div>
            </v-col>
          </v-row>
      ...
      <v-dialog content-class="br-b-r-100" v-model="guruRegister" width="600">
        <div class="ta-modal padding-100 center">
          ...
          <TextInput
            ...
            singleline
            rounded
            placeholder="DNI o Célula de identidad"
          ></TextInput>
          ...
          <v-row>
            <v-col>
              <p class="guru-description left my-2">
                Soy un/a profesional en turismo
              </p>
            </v-col>
            <v-col cols="2">
      ...
      <v-dialog content-class="br-b-r-100" v-model="confirmMail" width="600">
        <div
          class="ta-modal padding-100 center pt-0"
          @click.stop="
            confirmMail = false;
            doLogin();
            window.location.reload();
        ...
        >
          ...
          <p class="guru-description">
            Enviamos un correo de confirmación de cuenta a mail@cualquiera.com,
            seguí las instrucciones para continuar.
          </p>
        </div>
      </v-dialog>
      <!--  //////// ConfirmMailModal -->
