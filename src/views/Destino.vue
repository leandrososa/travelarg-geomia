          ...
          <v-col cols="7">
            <div class="user-image mb-6">
              ...
              <span class="tag user-tag white--text">
                  <img src="../assets/users/pesann.png" alt="" class="user-avatar">
                  pesann134
              </span>
            </div>
          ...
          <v-row align="center">
              <v-col>
                ...
                <v-expansion-panel>
                    ...
                    todo el año. Cada estación tiene su magia y una gran variedad de
                ...
                <v-expansion-panel>
                    ...
                    <ul>
                        ...
                        <li>
                        Botas impermeables&nbsp; y de abrigo para usar fuera, en la
                        nieve
                        </li>
                        <li>
                ...
                <v-expansion-panel>
                    ...
                    <v-expansion-panel-content>
                    La mayoría de los comercios abren de lunes a sábados de 9 a 13 y
                    de 16 a 21. Y los domingos de 18 a 21. En caso que necesites
                    realizar algún trámite bancario te informamos que los horarios de
                    los bancos son de lunes a viernes de 8 a 13.
                    </v-expansion-panel-content>
                </v-expansion-panel>
                </v-expansion-panels>
            </v-col>
    ...
    <section class="destination-map">
        <v-container>
            <div class="places-container" :class="{ show: !isOpen }">
                <PlaceCard @click.native="openDetails" name="Catedral Nuestra Señora del Nahuel Huapi" img="catedral-huapi" number="1" :stars="4"></PlaceCard>
                <PlaceCard @click.native="openDetails" name="Museo de la Patagonia" number="2" :stars="3"></PlaceCard>
                <PlaceCard @click.native="openDetails" name="Casino de Bariloche" img="casino-bariloche" number="3" :stars="4"></PlaceCard>
                <PlaceCard @click.native="openDetails" name="Patagonia Vinos" img="patagonia-vinos" number="4" :stars="5"></PlaceCard>
                <PlaceCard @click.native="openDetails" name="Parroquia San Eduardo" img="san-eduardo" number="5" :stars="2"></PlaceCard>
                <PlaceCard @click.native="openDetails" name="Chocolates Rapa Nui" img="rapa-nui" number="6" :stars="4"></PlaceCard>
                <PlaceCard @click.native="openDetails" name="Refugio Berghof" img="refugio-berghof" number="7" :stars="2"></PlaceCard>
                <PlaceCard @click.native="openDetails" name="Museo del Chocolate Havanna" img="museo-havanna" number="8" :stars="4"></PlaceCard>
            </div>
            <div class="place-detail elevation-9" :class="{ show: isOpen }">	
                <div class="detail-header">
                    <span v-ripple class="ticon-close" @click="closeDetails"></span>
                    <img src="../assets/places/catedral-huapi.jpg" alt="Catedral Nuestra Señora del Nahuel Huapi" class="detail-img"/>
                    <h5 class="detail-title">Catedral Nuestra Señora del Nahuel Huapi</h5>
                </div>
                <div class="detail-content">
                    <div class="detail-item" v-for="(resena, index) in resenas.resenas" :key="'detail-item' + index">
                        <div class="detail-item-header">
                            <router-link to="/perfil">
                                <img :src="require('../assets/users/' + resena.img)" :alt="resena.name" class="detail-item-avatar">
                                <span class="detail-item-author">{{resena.name}}</span>
                            </router-link>
                            <div class="detail-item-stars">
                                <span v-for="n in resena.rating" :key="'star-' + n" class="ticon-star"></span>
                                <span v-for="n in (5 - resena.rating)" :key="'emptystar-' + n" class="ticon-emptystar"></span>
                            </div>
                        </div>
